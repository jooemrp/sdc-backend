...
<div class="form-group row">
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-4">
        <div class="form-group">
            ...
            <label for="file-custom" type="button" id="file-custom-label" class="btn btn-primary form-control" id="upload">Upload</label>
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-4">
        <div class="form-group">
            <label>File </label>
            <input type="file" {{-- onchange="document.getElementById('file-custom-label').innerHTML = this.files[0].name" --}} style="display:none;" id="file-custom" aria-label="File browser example" name="content" accept="image/png, image/jpeg, image/jpg" multiple>
