...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    <div class="card-header">
        <h3 class="card-title">{{ trans('admin.crud.create') }} {{ trans('admin.panel.content') }}</h3>
        <div class="card-toolbar">
            <a href="{{ route('admin.content.index') }}" class="btn btn-light-primary font-weight-bolder mr-2">
    ...
    <!--begin::Form-->
    <form class="form" action="{{ route('admin.content.store') }}" method="POST" enctype="multipart/form-data" id="kt_form">
        @csrf
        <div class="card-body">
