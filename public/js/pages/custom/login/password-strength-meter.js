function passwordStrengthMeter(opts) {
    ...
    ${
        opts.containerElement
    } .password-strength-meter-score.psms-25 {width: 25%; background: ${
        opts.colorScore1 || "#ff7700"
    };}
    ${
        opts.containerElement
    } .password-strength-meter-score.psms-50 {width: 50%; background: ${
        opts.colorScore2 || "#ffff00"
    };}
    ${
        opts.containerElement
    } .password-strength-meter-score.psms-75 {width: 75%; background: ${
        opts.colorScore3 || "#aeff00"
    };}
    ${
        opts.containerElement
    } .password-strength-meter-score.psms-100 {width: 100%; background: ${
        opts.colorScore4 || "#00ff00"
    };}`;
