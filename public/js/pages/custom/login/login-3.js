    ...
    var _handleFormSignin = function () {
        ...
        FormValidation.formValidation(form, {
            ...
            .on("core.form.invalid", function () {
                Swal.fire({
                    text: "Terdapat kesalahan pengisian data. Mohon periksa kembali, lalu isi dengan lengkap.",
                    icon: "error",
                    buttonsStyling: false,
                    confirmButtonText: "Oke",
                    customClass: {
            ...
            FormValidation.formValidation(form, {
                fields: {
                    name: {
                        validators: {
                            notEmpty: {
                                message: "Anda harus mengisi Nama lengkap",
                            },
                        },
                    },
                    phone: {
                        validators: {
                            notEmpty: {
                                message: "No. Handphone harus terisi",
                            },
                        },
                    },
                },
            ...
            FormValidation.formValidation(form, {
                fields: {
                    province: {
                        validators: {
                            notEmpty: {
                                message: "Kolom Provinsi harus terisi",
                            },
                        },
                    },
                    city: {
                        validators: {
                            notEmpty: {
                                message: "Kolom Kota harus terisi",
                            },
                        },
                    },
                    address: {
                        validators: {
                            notEmpty: {
                                message: "Kolom Alamat harus terisi",
                            },
                        },
                    },
                },
                ...
                fields: {
                    email: {
                        validators: {
                            ...
                            emailAddress: {
                                message: "Gunakan alamat email yang valid",
                            },
                        },
                    },
                    password: {
                    ...
                    password_confirmation: {
                        validators: {
                            notEmpty: {
                                message: "Konfirmasi password harus terisi",
                            },
                            identical: {
                                enabled: true,
                                compare: function () {
