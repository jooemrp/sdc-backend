        ...
        uppyDrag.on("complete", function (file) {
            ...
            $.each(file.successful, function (index, value) {
                ...
                if (imageType.test(value.type)) {
                    thumbnail =
                        '<div class="uppy-thumbnail"><img src="' +
                        value.uploadURL +
                        '"/></div>';
                }
                var sizeLabel = "bytes";
                ...
                imagePreview +=
                    '<div class="uppy-thumbnail-container" data-id="' +
                    value.id +
                    '">' +
                    thumbnail +
                    ...
                    ')</span><span data-id="' +
                    value.id +
                    '" class="uppy-remove-thumbnail"><i class="flaticon2-cancel-music"></i></span></div>';
            });
